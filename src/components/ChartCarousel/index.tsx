...
export default function ChartCarousel() {
  return (
    <>
      <div className="bg-gray-50 rounded-xl w-full flex p-5 shadow-card" style={{ height: "400px" }}>
        <div className="flex flex-col w-96 gap-2 font-quicksand ">
          ...
          <div className="flex items-center gap-2">
              <div className="bg-gray-500 w-6 h-6 rounded-full flex items-center justify-center shadow-button">
                <FaPlay color={colors.gray['50']} size={12}/>
              </div>
              <div className="flex gap-1">
                <div className="bg-lime-700 rounded-3xl w-16 h-4"></div>
                <div className="bg-gray-400 rounded-full w-4 h-4"></div>
                <div className="bg-gray-400 rounded-full w-4 h-4"></div>
              </div>
          </div>
        </div>
        <div className="flex-1 flex items-center justify-center ml-8 rounded-lg">
            <img src={chartImg} className="h-full w-4/5" />
            legendas aqui
        </div>
      </div>
      <div className="flex gap-2 justify-end h-8">
        <div className="bg-gray-50 rounded-full w-8 h-8 flex items-center justify-center cursor-pointer hover:bg-gray-200 transition-colors shadow-button hover:shadow-card-hover">
